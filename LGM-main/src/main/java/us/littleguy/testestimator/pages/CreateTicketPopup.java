...
public class CreateTicketPopup extends BasePageObject {
	
	private By title = By.cssSelector("h3[title='Help & Support']");
	//private By requester = By.id("helpdesk_ticket_email");
	//private By subject = By.cssSelector(".control-label.required.subject-label");
	...
	public CreateTicketPopup(WebDriver driver, Logger log) {
		super(driver, log);
